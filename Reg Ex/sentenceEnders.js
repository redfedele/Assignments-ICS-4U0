function sentenceEnders() {
  ...
  text("The amount of exclamation marks are: " + exclamations, width/2 -75, height/4 +80);
  text("The amount of periods are:" + periods, width/2 -75, height/4 + 100);
  text("The amount of question marks are : " + questionMarks, width/2 -75, height/4 + 120);
}